...
while ($row = mysqli_fetch_array($w)) {
    ...
    $s1 = 0;
    $id=$row['p_id'];
    $s1s = "SELECT o_quantity FROM order_table WHERE p_id= '$id' AND order_date='$currentDateTime' ";
            ...
            <div class="row m-5">
                <div class="card flex-fill">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Today Order Products</h4>
